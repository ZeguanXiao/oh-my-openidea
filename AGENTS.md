...
**oh-my-openidea** - A CS/ML research idea generation framework built as an OpenCode plugin. Orchestrates six specialized research agents across the full idea pipeline: literature survey, synthesis, hypothesis generation, novelty checking, experiment design, and paper writing. Built with TypeScript, Bun, and Biome.
...
# "plugin": ["file:///path/to/oh-my-openidea"]
