...
The `src/tools/` directory provides the core tool implementations for the oh-my-openidea plugin. It exposes three main categories of tools:
...
- **Install location**: `~/.cache/oh-my-openidea/bin/rg` (Linux/macOS), `%LOCALAPPDATA%\oh-my-openidea\bin\rg.exe` (Windows)
...
- **Install location**: `~/.cache/oh-my-openidea/bin/sg` (Linux/macOS), `%LOCALAPPDATA%\oh-my-openidea\bin\sg.exe` (Windows)
