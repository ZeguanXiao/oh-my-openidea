...
|-------|--------------|-------|-------------|-------------|
| Surveyor | Literature search | AlphaXiv MCP, websearch | Read-only, parallel | 0.1 |
| Synthesizer | Idea synthesis | AlphaXiv MCP, websearch | Generative, cites evidence | 0.5 |
| Critic | Novelty checking | AlphaXiv MCP | Adversarial, read-only | 0.2 |
| Architect | Experiment design | AlphaXiv MCP, websearch | Structured output | 0.3 |
